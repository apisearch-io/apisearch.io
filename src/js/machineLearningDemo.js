...
let albumsArray = [
    ...
    'good-for-you-mw0002856176', 'jazz-magnetism-mw0002385072', 'la-la-land-original-motion-picture-soundtrack-mw0002992825',
    'legend-mw0000194760', 'the-xx-mw0000826745', 'ellington-at-newport-mw0000879617',
    'im-still-1-mw0002161743', 'a-sky-full-of-stars-mw0002697662', 'the-resistance-mw0000825211',
    'am-mw0002557264', 'via-mandarina-mw0001755965', 'midnight-city-mw0002223325',
];
    ...
    printChoices(uuids) {
        ...
        if (uuids.length === 0) {
            resultBlock.innerHTML = template(
                `<div class="col-12">
                    <div class="c-machineLearning__noMoreChoices">
                        <h4 class="c-machineLearning__noMoreChoicesTitle">There are no more choices</h4>
                    </div>
                </div>`
            )();
            ...
            document
                ...
                .forEach(item =>
                    item.addEventListener('click', () => {
                        setTimeout(() => {
                            // add like on item
                            if (!item.classList.contains('c-machineLearning__album--disabled')) {
                                item
                                    .classList
                                    .add('c-machineLearning__album--liked')
                                ;
                            }
                            ...
                            document
                                .querySelectorAll('.c-machineLearning__album--choice')
                                .forEach(toDisableItem => {
                                    if (!toDisableItem.classList.contains('c-machineLearning__album--liked')) {
                                        toDisableItem
                                            .classList
                                            .add('c-machineLearning__album--disabled');
                                    }
                                });
                        }, 75);
